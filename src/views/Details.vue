    ...
    <main id="main" class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb small bg-transparent">
                <li class="breadcrumb-item">
                    <a class="text-dark font-weight-bold small" href="#"
                        >首页</a
                    >
                </li>
                <li class="breadcrumb-item">
            ...
            <div class="row pr-3">
                ...
                <div id="details" class="col pl-0">
                    <h6 class="font-weight-bold">
                        ...
                        处理器/8GB内存/128GB SSD闪存 MMGF2CH/A)
                    </h6>
                    <h6>
                        <a
                    ...
                    <div>
                        ...
                        >
                            <img
                                src="/img/product_detail/product_detail_img6.png"
                            />
                            <br />
                            收藏
                        </a>
        ...
        <div class="container mb-5">
            ...
            <div id="recommend" class="border pl-3">
                <ul
                    class="list-unstyled"
                    style="width: 1100px; margin-left: -220px"
                >
                    <li class="float-left">
                        <div
                            class="card mb-1 p-4 border-0 bg-transparent box-shadow"
                        >
                            <img
                                class="card-img-top"
        ...
        <nav class="navbar flex-md-nowrap p-0 ml-3">
            <form class="form-inline pl-2">
                ...
                <button
                    class="btn bg-transparent rounded-0 pt-3 pb-2"
                    type="button"
                >
                    <h5>商品评价</h5>
                </button>
            ...
            <ul class="navbar-nav">
                <li class="nav-item text-nowrap">
                    <a
                        class="btn btn-primary p-3 border-bottom"
                        href="javascript:;"
                    >
                        <h5>
                            <img
            ...
            <div class="row mr-1">
                <div class="col-md-10 pt-5">
                    ...
                    <h6 class="d-inline-block ml-3">
                        规格参数
                        <img
                            src="/img/product_detail/product_detail_icon_1.png"
                            alt=""
                        />
                    </h6>
                    <div class="pl-3">
                    ...
                    <h6 class="d-inline-block mt-4 mb-3 ml-3">
                        商品介绍
                        <img
                            src="/img/product_detail/product_detail_icon_4.png"
                            alt=""
                        />
                    </h6>
                    <div>
                        ...
                        <div>
                            <div>
                                <img
                                    alt=""
                                    src="/img/product/detail/57b15616N1e285f09.jpg"
                                />
                            </div>
                        </div>
                        <div>
                            <div class="pl-3 small">
                                技术规格请前往
                                www.apple.com/cn/macbook-air/specs.html
                                查看完整内容。
                            </div>
                        </div>
                    </div>
                    ...
                    <h6 class="d-inline-block mt-4 mb-3 ml-3">
                        售后保障
                        <img
                            src="/img/product_detail/product_detail_icon_3.png"
                            alt=""
                        />
                    </h6>
                    <div class="pl-3">
                    ...
                    <h6 class="d-inline-block mt-4 mb-3 ml-3">
                        包装清单
                        <img
                            src="/img/product_detail/product_detail_icon_2.png"
                            alt=""
                        />
                    </h6>
                    <div class="pl-3">
                        <p class="small">
                            笔记本 x1 适配器 x1 电源线 x1 电池 x1
                            说明书（电子版）x1
                            备注：笔记本电脑的背面只会标注此电脑的系列，例如：
                            XPS 13-9360
